...
[`socket()`](https://beej.us/guide/bgnet/html/index-wide.html#socketman), [`getaddrinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getaddrinfoman), [`listen()`](https://beej.us/guide/bgnet/html/index-wide.html#listenman), [`struct sockaddr_in`](https://beej.us/guide/bgnet/html/index-wide.html#structsockaddrman)
...
[`getaddrinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getaddrinfoman), [`socket()`](https://beej.us/guide/bgnet/html/index-wide.html#socketman), [`struct sockaddr_in`](https://beej.us/guide/bgnet/html/index-wide.html#structsockaddrman), [`struct in_addr`](https://beej.us/guide/bgnet/html/index-wide.html#structsockaddrman)
...
[`socket()`](https://beej.us/guide/bgnet/html/index-wide.html#socketman), [`bind()`](https://beej.us/guide/bgnet/html/index-wide.html#bindman)
...
[`socket()`](https://beej.us/guide/bgnet/html/index-wide.html#socketman), [`shutdown()`](https://beej.us/guide/bgnet/html/index-wide.html#shutdownman)
...
The `servname` parameter is basically the port number. It can be a port number (passed as a string, like “80”), or it can be a service name, like “http” or “tftp” or “smtp” or “pop”, etc. Well-known service names can be found in the [IANA Port List](https://www.iana.org/assignments/port-numbers)[48](https://beej.us/guide/bgnet/html/index-wide.html#fn48) or in your `/etc/services` file.
...
[`gethostbyname()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman), [`getnameinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getnameinfoman)
...
[`gethostbyname()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman)
...
[`getaddrinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getaddrinfoman), [`getnameinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getnameinfoman), [`gethostname()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostnameman), [`errno`](https://beej.us/guide/bgnet/html/index-wide.html#errnoman), [`perror()`](https://beej.us/guide/bgnet/html/index-wide.html#perrorman), [`strerror()`](https://beej.us/guide/bgnet/html/index-wide.html#perrorman), [`struct in_addr`](https://beej.us/guide/bgnet/html/index-wide.html#structsockaddrman)
...
[`getaddrinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getaddrinfoman), [`gethostbyaddr()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman)
...
[`gethostname()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostnameman), [`gethostbyname()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman), [`gethostbyaddr()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman)
...
[`perror()`](https://beej.us/guide/bgnet/html/index-wide.html#perrorman), [`strerror()`](https://beej.us/guide/bgnet/html/index-wide.html#perrorman)
...
| `cmd`        | **Description**                                                                                                                                                                                                                          |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `O_NONBLOCK` | Set the socket to be non-blocking. See the section on [blocking](https://beej.us/guide/bgnet/html/index-wide.html#blocking) for more details.                                                                                            |
...
[Blocking](https://beej.us/guide/bgnet/html/index-wide.html#blocking), [`send()`](https://beej.us/guide/bgnet/html/index-wide.html#sendman)
...
[`inet_ntop()`](https://beej.us/guide/bgnet/html/index-wide.html#inet_ntopman), [`inet_pton()`](https://beej.us/guide/bgnet/html/index-wide.html#inet_ntopman), [`gethostbyname()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman), [`gethostbyaddr()`](https://beej.us/guide/bgnet/html/index-wide.html#gethostbynameman)
...
[`getaddrinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getaddrinfoman)
...
[`accept()`](https://beej.us/guide/bgnet/html/index-wide.html#acceptman), [`bind()`](https://beej.us/guide/bgnet/html/index-wide.html#bindman), [`socket()`](https://beej.us/guide/bgnet/html/index-wide.html#socketman)
...
[`errno`](https://beej.us/guide/bgnet/html/index-wide.html#errnoman)
...
[`select()`](https://beej.us/guide/bgnet/html/index-wide.html#selectman)
...
[`send()`](https://beej.us/guide/bgnet/html/index-wide.html#sendman), [`sendto()`](https://beej.us/guide/bgnet/html/index-wide.html#sendman), [`select()`](https://beej.us/guide/bgnet/html/index-wide.html#selectman), [`poll()`](https://beej.us/guide/bgnet/html/index-wide.html#pollman), [Blocking](https://beej.us/guide/bgnet/html/index-wide.html#blocking)
...
Note for Linux users: Linux’s `select()` can return “ready-to-read” and then not actually be ready to read, thus causing the subsequent `read()` call to block. You can work around this bug by setting `O_NONBLOCK` flag on the receiving socket so it errors with `EWOULDBLOCK`, then ignoring this error if it occurs. See the [`fcntl()` man page](https://beej.us/guide/bgnet/html/index-wide.html#fcntlman)for more info on setting a socket to non-blocking.
...
[`poll()`](https://beej.us/guide/bgnet/html/index-wide.html#pollman)
...
[`fcntl()`](https://beej.us/guide/bgnet/html/index-wide.html#fcntlman)
...
| `MSG_DONTWAIT`  | If `send()` would block because outbound traffic is clogged, have it return `EAGAIN`. This is like a “enable non-blocking just for this send.” See the section on [blocking](https://beej.us/guide/bgnet/html/index-wide.html#blocking) for more details.                                                   |
...
Returns the number of bytes actually sent, or `-1` on error (and `errno` will be set accordingly). Note that the number of bytes actually sent might be less than the number you asked it to send! See the section on [handling partial `send()`s](https://beej.us/guide/bgnet/html/index-wide.html#sendall) for a helper function to get around this.
...
[`recv()`](https://beej.us/guide/bgnet/html/index-wide.html#recvman), [`recvfrom()`](https://beej.us/guide/bgnet/html/index-wide.html#recvman)
...
[`close()`](https://beej.us/guide/bgnet/html/index-wide.html#closeman)
...
[`accept()`](https://beej.us/guide/bgnet/html/index-wide.html#acceptman), [`bind()`](https://beej.us/guide/bgnet/html/index-wide.html#bindman), [`getaddrinfo()`](https://beej.us/guide/bgnet/html/index-wide.html#getaddrinfoman), [`listen()`](https://beej.us/guide/bgnet/html/index-wide.html#listenman)
...
[`accept()`](https://beej.us/guide/bgnet/html/index-wide.html#acceptman), [`bind()`](https://beej.us/guide/bgnet/html/index-wide.html#bindman), [`connect()`](https://beej.us/guide/bgnet/html/index-wide.html#connectman), [`inet_aton()`](https://beej.us/guide/bgnet/html/index-wide.html#inet_ntoaman), [`inet_ntoa()`](https://beej.us/guide/bgnet/html/index-wide.html#inet_ntoaman)
